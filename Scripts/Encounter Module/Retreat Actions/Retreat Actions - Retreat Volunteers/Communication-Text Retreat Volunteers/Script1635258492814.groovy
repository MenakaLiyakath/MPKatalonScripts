...
WebUI.verifyElementNotClickable(findTestObject('Encounter(SessionOrRetreat)/Retreat/page_retreatVolunteer/button_retreatVolunteer_text'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.modifyObjectProperty(dynamicObject, 'xpath', 'equals', ('//table[@class=\'volunteers-table\']//kendo-grid-list//tbody//tr//td[text()=\'' +
...
WebUI.verifyElementClickable(findTestObject('Encounter(SessionOrRetreat)/Retreat/page_retreatVolunteer/button_retreatVolunteer_text'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Encounter(SessionOrRetreat)/Retreat/page_retreatVolunteer/button_retreatVolunteer_email'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Encounter(SessionOrRetreat)/Retreat/page_retreatVolunteer/lightbox_retreatVolunteer_emailVolunteers/radio_emailVolunteers_text'), 
    FailureHandling.CONTINUE_ON_FAILURE)
