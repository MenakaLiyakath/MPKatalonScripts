...
/* This script is to verify curently running filter for sessions*/

/*Validate currently running and completed checkboxes are checked by default*/
WebUI.verifyElementChecked(findTestObject('Encounter(SessionOrRetreat)/Session/page_sessionOverview/checkBox_sessionOverview_currentlyRunningSession'), 1, FailureHandling.CONTINUE_ON_FAILURE)
WebUI.verifyElementChecked(findTestObject('Encounter(SessionOrRetreat)/Session/page_sessionOverview/checkBox_sessionOverview_completedSession'), 1, FailureHandling.CONTINUE_ON_FAILURE)

/*Uncheck completed sessions checkbox*/
...
WebUI.comment("Validation for Currently Running Filter")
...
WebUI.uncheck(findTestObject('Encounter(SessionOrRetreat)/Session/page_sessionOverview/checkBox_sessionOverview_currentlyRunningSession'), FailureHandling.CONTINUE_ON_FAILURE)
