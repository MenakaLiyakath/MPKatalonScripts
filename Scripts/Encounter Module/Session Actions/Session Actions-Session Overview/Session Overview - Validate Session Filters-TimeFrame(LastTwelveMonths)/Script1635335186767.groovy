...
/* This script is to verify Timeframe(Last 12 months) filter for sessions*/
...
//Date parsedStartDate = new SimpleDateFormat('yyyy-MM-dd hh:mm:ss').parse(startdateandtime)
...
if(daysBetween<=365)
{
	...
	WebUI.modifyObjectProperty(dynamicObject, 'xpath', 'equals', '//ng-select[@id=\'sessionTimeFrameSelect\']//div//span[text()=\'Last 12 Months\']', true, FailureHandling.CONTINUE_ON_FAILURE)
