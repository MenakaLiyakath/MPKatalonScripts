...
def PhoneNumber1 = (((('(' + findTestData('Encounter/SessionParticipants').getValue(6, 4).substring(0, 3)) + ') ') + findTestData('Encounter/SessionParticipants').getValue(
    6, 4).substring(3, 6)) + '-') + findTestData('Encounter/SessionParticipants').getValue(6, 4).substring(6)

def PhoneNumber2 = (((('(' + findTestData('Encounter/SessionParticipants').getValue(6, 5).substring(0, 3)) + ') ') + findTestData('Encounter/SessionParticipants').getValue(
    6, 5).substring(3, 6)) + '-') + findTestData('Encounter/SessionParticipants').getValue(6, 5).substring(6)

def PhoneNumber3 = (((('(' + findTestData('Encounter/SessionParticipants').getValue(6, 6).substring(0, 3)) + ') ') + findTestData('Encounter/SessionParticipants').getValue(
    6, 6).substring(3, 6)) + '-') + findTestData('Encounter/SessionParticipants').getValue(6, 6).substring(6)
...
WebUI.verifyElementNotClickable(findTestObject('Encounter(SessionOrRetreat)/Session/page_sessionsParticipants/button_sessionsParticipant_text'), 
...
WebUI.verifyElementClickable(findTestObject('Encounter(SessionOrRetreat)/Session/page_sessionsParticipants/button_sessionsParticipant_text'), 
    FailureHandling.CONTINUE_ON_FAILURE)
