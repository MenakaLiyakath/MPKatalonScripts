...
//for (def rowindex = 1; rowindex <= findTestData('Grow-People').getRowNumbers(); rowindex++) {
...
WebUI.verifyElementNotClickable(findTestObject('module_grow/page_group/tab_group_members/button_members_text'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementClickable(findTestObject('module_grow/page_group/tab_group_members/button_members_text'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('module_grow/page_group/tab_group_members/button_members_text'), FailureHandling.CONTINUE_ON_FAILURE)
