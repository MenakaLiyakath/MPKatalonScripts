...
WebUI.modifyObjectProperty(dynamicObject, 'xpath', 'equals', '//div[@id=\'divGrowGroupMembersContainer\']//tr//td//span[text()=\''+LastName+'\']', true, FailureHandling.CONTINUE_ON_FAILURE)
